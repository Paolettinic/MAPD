...
def eqt_pos_to_coordinates(pos_x, pos_y, cs = 10) -> Tuple[int, int, int, int, int, int]:
    return pos_x * cs, pos_y * cs + cs, pos_x * cs + cs, pos_y * cs + cs, pos_x * cs + cs //2, int(pos_y * cs + 0.234 *cs)
